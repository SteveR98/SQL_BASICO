...
SET DEFINE OFF;
Insert into HR.AFICION (AFICION_ID,NOMBREGUERRA,EQUIPO_ID) values ('1','lallala',null);
Insert into HR.AFICION (AFICION_ID,NOMBREGUERRA,EQUIPO_ID) values ('2','lololo',null);
REM INSERTING into HR.AFICIONADOS
SET DEFINE OFF;
REM INSERTING into HR.CANTICOS
SET DEFINE OFF;
Insert into HR.CANTICOS (CANTICOS_ID,CANCIONES) values ('1','la patata');
Insert into HR.CANTICOS (CANTICOS_ID,CANCIONES) values ('2','Koala');
...
SET DEFINE OFF;
Insert into HR.EQUIPO (EQUIPO_ID) values ('1');
Insert into HR.EQUIPO (EQUIPO_ID) values ('2');
REM INSERTING into HR.ESTADIO
SET DEFINE OFF;
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD) values ('1','YUYU','ROEF');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD) values ('2','TTER','DDD');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD) values ('3','JAJAJ','FFFF');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD) values ('4','LOLO','MMMM');
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,SUELDO,EQUIPO_ID) values ('3','MARK','8000',null);
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,SUELDO,EQUIPO_ID) values ('4','KIKI','8755',null);
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,SUELDO,EQUIPO_ID) values ('1','PEPE','9900',null);
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,SUELDO,EQUIPO_ID) values ('2','LOLO','2145',null);
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."EQUIPOS_PK" ON "HR"."EQUIPO" ("EQUIPO_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" ADD CONSTRAINT "EQUIPOS_PK" PRIMARY KEY ("EQUIPO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "EQUIPO_FK1" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."EQUIPO" ("EQUIPO_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AFICIONADOS
--------------------------------------------------------

  ALTER TABLE "HR"."AFICIONADOS" ADD CONSTRAINT "AFICION_FK3" FOREIGN KEY ("AFICIONADOS_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."CANTICOS" ADD CONSTRAINT "AFICION_FK" FOREIGN KEY ("CANTICOS_ID")
	  REFERENCES "HR"."AFICION" ("AFICION_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPO_FK3" FOREIGN KEY ("EQUIPO_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."NOMBREGUERRA" ADD CONSTRAINT "AFICION_FK1" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."AFICION" ("AFICION_ID") ON DELETE SET NULL ENABLE;
