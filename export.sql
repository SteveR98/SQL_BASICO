...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."AFICION" 
   (	"AFICION_ID" VARCHAR2(20 BYTE), 
	"EQUIPO_ID" NUMBER(1,0), 
	"NOMGUERRA_ID" NUMBER(1,0)
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."AFICION"."AFICION_ID" IS 'PRIMARY KEY FROM AFICION TABLE
';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."CANTICOS" 
   (	"CANTICOS_ID" VARCHAR2(20 BYTE), 
	"AFICION_ID" NUMBER(1,0), 
	"CANCIONES" VARCHAR2(20 BYTE), 
	"REPERTORIO" NUMBER(2,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."CANTICOS"."CANTICOS_ID" IS 'PRIMARY KEY FROM CANTICOS TABLE';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."EQUIPO"."EQUIPO_ID" IS 'PRIMARY KEY FROM EQUIPO TABLE';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."ESTADIO"."ESTADIO_ID" IS 'PRIMARY KEY FROM ESTADIO TABLE';
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table NOMGUERRA
--------------------------------------------------------

  CREATE TABLE "HR"."NOMGUERRA" 
   (	"NOMGUERRA_ID" VARCHAR2(20 BYTE), 
	"AFICION_ID" NUMBER(1,0), 
	"LEMA" VARCHAR2(20 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."NOMGUERRA"."NOMGUERRA_ID" IS 'PRIMARY KEY FROM NOMGUERRA TABLE';
--------------------------------------------------------
...
REM INSERTING into HR.NOMGUERRA
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index NOMGUERRA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."NOMGUERRA_PK" ON "HR"."NOMGUERRA" ("NOMGUERRA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
--  Constraints for Table NOMGUERRA
--------------------------------------------------------

  ALTER TABLE "HR"."NOMGUERRA" ADD CONSTRAINT "NOMGUERRA_PK" PRIMARY KEY ("NOMGUERRA_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."NOMGUERRA" MODIFY ("NOMGUERRA_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."JUGADORES" MODIFY ("DORSAL" NOT NULL ENABLE);
  ALTER TABLE "HR"."JUGADORES" MODIFY ("EDAD" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."ESTADIO" MODIFY ("EQUIPO_ID" NOT NULL ENABLE);
  ALTER TABLE "HR"."ESTADIO" MODIFY ("AFORO" NOT NULL ENABLE);
