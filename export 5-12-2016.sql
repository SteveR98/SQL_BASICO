...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."NOMBREGUERRA" 
   (	"NOMBREFUERRA_ID" VARCHAR2(100 BYTE), 
...
SET DEFINE OFF;
Insert into HR.AFICION (AFICION,NOMBREGUERRA,EQUIPO_ID,"PEÑAS") values ('1','LAS ROCAS SON MUY DURAS','1','PIEDRAS DEL MONTE');
Insert into HR.AFICION (AFICION,NOMBREGUERRA,EQUIPO_ID,"PEÑAS") values ('2','AMIGOS DE ANTONIO','2','TOLDOS ANTONIO');
REM INSERTING into HR.CANTICOS
SET DEFINE OFF;
Insert into HR.CANTICOS (CANTICOS_ID,CANCIONES,AFICION_ID) values ('1','PIEDRA PULIDA','1');
Insert into HR.CANTICOS (CANTICOS_ID,CANCIONES,AFICION_ID) values ('2','ANTOÑINO DE MI VIDA','1');
...
SET DEFINE OFF;
Insert into HR.EQUIPOS (EQUIPO_ID,NOMBRE,FECHAFUNDACION,COLORES,AFICION_ID) values ('1','LOS PEPES',to_date('01/01/01','DD/MM/RR'),'ROJO/VERDE','1');
Insert into HR.EQUIPOS (EQUIPO_ID,NOMBRE,FECHAFUNDACION,COLORES,AFICION_ID) values ('2','LOS ANTOS',to_date('05/12/16','DD/MM/RR'),'VERDE/AZUL','2');
REM INSERTING into HR.ESTADIO
SET DEFINE OFF;
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD,AFORO) values ('1','EL PRIMERO','ESA ES','80000');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,CIUDAD,AFORO) values ('2','EL SEGUNDO','ESA ES','2');
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,APELLIDOS,TELEFONO,SUELDO,EQUIPO_ID) values ('1','STEVE','ROCK98','9898989898','1','1');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,APELLIDOS,TELEFONO,SUELDO,EQUIPO_ID) values ('2','ANTONIO','LOPEZ','5646812564','2','1');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,APELLIDOS,TELEFONO,SUELDO,EQUIPO_ID) values ('3','JUANA','DEL NARCO','476378367','666','1');
...
REM INSERTING into HR.NOMBREGUERRA
SET DEFINE OFF;
Insert into HR.NOMBREGUERRA (NOMBREFUERRA_ID,TITULOS,AFICION_ID) values ('LAS PIDRAS SON MUY DURAS','BE STONE MY FRIEND','1');
Insert into HR.NOMBREGUERRA (NOMBREFUERRA_ID,TITULOS,AFICION_ID) values ('ANTONIO Y SUS TOLDOS 2016','BEST TOLDOS ANTONIO FOR EVER','2');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."AFICION_PK" ON "HR"."AFICION" ("AFICION") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."NOMBREGUERRA_PK" ON "HR"."NOMBREGUERRA" ("NOMBREFUERRA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "AFICION_PK" PRIMARY KEY ("AFICION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."AFICION" MODIFY ("NOMBREGUERRA" NOT NULL ENABLE);
  ALTER TABLE "HR"."AFICION" MODIFY ("AFICION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."NOMBREGUERRA" ADD CONSTRAINT "NOMBREGUERRA_PK" PRIMARY KEY ("NOMBREFUERRA_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ...
  ALTER TABLE "HR"."NOMBREGUERRA" MODIFY ("NOMBREFUERRA_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "EQUIPOS_FK" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPOS" ("EQUIPO_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CANTICOS
--------------------------------------------------------

  ALTER TABLE "HR"."CANTICOS" ADD CONSTRAINT "AFICION_FK2" FOREIGN KEY ("CANTICOS_ID")
	  REFERENCES "HR"."AFICION" ("AFICION") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPOS" ADD CONSTRAINT "ESTADIO_FK" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."ESTADIO" ("ESTADIO_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPOS_FK2" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPOS" ("EQUIPO_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."NOMBREGUERRA" ADD CONSTRAINT "AFICION_FK" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."AFICION" ("AFICION") ON DELETE CASCADE ENABLE;
